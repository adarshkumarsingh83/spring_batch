...
public class EmployeeFieldSetMapper implements FieldSetMapper<Employee> {
    ...
    final private static Logger LOGGER=Logger.getLogger(EmployeeFieldSetMapper.class);
    private final  SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");

    @Override
    public Employee mapFieldSet(FieldSet fieldSet) throws BindException {
        final Employee employee = new Employee();
        final String empId=fieldSet.readString(0);
        employee.setEmpId(Integer.parseInt((empId.contains(";")?empId.substring(empId.indexOf(";")+1):empId)));
